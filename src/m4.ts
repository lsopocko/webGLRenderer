...
export const xRotation = (angleInRadians: number): number[] => {
...
export const yRotation = (angleInRadians: number): number[] => {
  const c = Math.cos(angleInRadians);
  const s = Math.sin(angleInRadians);
...
export const zRotation = (angleInRadians: number): number[] => {
  const c = Math.cos(angleInRadians);
  const s = Math.sin(angleInRadians);
...
export const translate = (m, tx, ty, tz) => {
  return multiply(m, translation(tx, ty, tz));
};

export const xRotate = (m, angleInRadians) => {
  return multiply(m, xRotation(angleInRadians));
};

export const yRotate = (m, angleInRadians) => {
  return multiply(m, yRotation(angleInRadians));
};

export const zRotate = (m, angleInRadians) => {
  return multiply(m, zRotation(angleInRadians));
};

export const scale = (m, sx, sy, sz) => {
